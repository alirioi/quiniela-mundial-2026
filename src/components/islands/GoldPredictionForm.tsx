        ...
        <div className="disclaimer-box p-4 rounded-2xl flex items-start gap-3 text-xs sm:text-sm font-medium">
          ...
          <div>
            ...
            <p className="mt-0.5 text-slate-300">
              El mundial ha comenzado (o faltan menos de 2 horas para el primer partido). Las predicciones de desempate se encuentran estrictamente bloqueadas y no admiten más modificaciones.
            </p>
          </div>
        </div>
      ) : (
