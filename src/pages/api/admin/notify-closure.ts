    ...
    for (const [email, fullName] of recipients.entries()) {
      const htmlContent = `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff; color: #1e293b;">
          ...
          <p>Te informamos que las inscripciones y compras de cupos adicionales para la <strong>Quiniela Mundial 2026</strong> han cerrado oficialmente el 11 de Junio a las 12:00 PM (Mediodía, Hora de Venezuela).</p>
          ...
          <div style="margin: 24px 0; font-size: 14px; line-height: 1.5;">
            ...
            <ul style="padding-left: 20px; margin: 0; color: #475569;">
              <li style="margin-bottom: 6px;"><strong>Bloqueo de Pronósticos:</strong> Las predicciones de cada partido se bloquean automáticamente <strong>5 minutos antes</strong> de su hora programada de inicio. ¡No olvides llenar tus marcadores a tiempo!</li>
