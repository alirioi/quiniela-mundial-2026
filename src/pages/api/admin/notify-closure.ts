    ...
    for (const [email, fullName] of recipients.entries()) {
      const htmlContent = `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff; color: #1e293b;">
          ...
          <p>Te informamos que las inscripciones y compras de cupos adicionales para la <strong>Quiniela Mundial 2026</strong> han cerrado oficialmente de acuerdo al reglamento (48 horas antes del pitazo inicial).</p>
