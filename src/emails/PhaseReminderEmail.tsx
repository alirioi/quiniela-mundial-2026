    ...
    <Layout previewText={previewText}>
      ...
      <div style={{ margin: '16px 0', padding: '14px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
        <ul style={{ margin: 0, paddingLeft: '20px', color: '#334155', fontSize: '15px' }}>
          ...
          {missingFirstMatch && (
            <li style={{ marginBottom: '8px' }}>
              ⚽ <strong>Primer Partido del Mundial:</strong> Recuerda pronosticar el partido inaugural. Las predicciones de cada partido se bloquean automáticamente <strong>2 horas antes</strong> de su inicio.
            </li>
          )}
        </ul>
      </div>
